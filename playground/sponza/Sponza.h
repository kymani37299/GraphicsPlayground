...
namespace SponzaSample
{
	...
	public:
		...
		void SetupRenderer() override
		{
			...
			sceneRenderPass->Load("playground/sponza/resources/GlassBunny/scene.gltf", Vec3(0.0f,50.0f,0.0f), VEC3_ONE * 500.0f, Vec3(0.0,0.0,1.57));
			sceneRenderPass->Load("playground/sponza/resources/GlassBunny/scene.gltf", Vec3(0.0f,50.0f,50.0f), VEC3_ONE * 500.0f, Vec3(0.0, 0.0, 1.57));
